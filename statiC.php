<?php
/*-----------------------------------------------------------
Creation fichier Static à partir de la DB MySQL de Weewx
Xavier JULIE <xav@xj1.fr> https://fortmahon.webcam/meteo.php
...
-------------------------------------------------------------
*/
# Parametres de connexion à la base de données Weewx à renseigner
$db_host='localhost';
$db_user='DB_USER';
$db_pass='DB_PASSWORD';
$db_name='WEEWX_DB_NAME';
$db_table='TABLE NAME';
...
$res=mysql_query("select * from $db_name.$db_table order by dateTime desc limit 1;");
...
//get maxtemp
$res = mysql_query("select * from ".$db_table."_day_outTemp order by dateTime DESC limit 1;");
$row = mysql_fetch_row($res);
